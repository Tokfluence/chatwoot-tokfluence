...
Devise.setup do |config|
  ...
  _mailer_sender_env = ENV['MAILER_SENDER_EMAIL'].to_s
  config.mailer_sender = if _mailer_sender_env.present? && !_mailer_sender_env.include?('example.com')
                           _mailer_sender_env
                         else
                           'Tokfluence <contact@tokfluence.com>'
                         end
